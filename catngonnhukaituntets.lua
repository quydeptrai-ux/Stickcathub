...
if getgenv().Race['Lock Race'] then
...
if _G.On_Next_Generation then
    ...
    if getgenv().Quest['Evo Race']['Evo V3'] then
		getgenv().Quest['Evo Race V1'] = true
		getgenv().Quest['Evo Race V2'] = true
		getgenv().Quest['Evo Race V3'] = true
    end
    _G.Main = {
        getgenv().Setting['FPS Booster'],
        getgenv().Setting['White Screen'],
        getgenv().Setting['Disible Gui'],
        getgenv().Setting['AFK Check'],
        getgenv().Setting['Lock Fruit'],
        getgenv().Setting['Rejoin'],
        getgenv().Fruit['Bring Fruit'],
        getgenv().Quest['Kill Boss']
    }
...
TextLabel.Text = "Cat Hub Kaitun / gaytayðŸ˜­"
...
TextLabel1.Text = "Cat hub kaitun Script â€¢ .gg/"
